...
import { Timeline, TimelineItem, TimelineSeparator, TimelineConnector, TimelineContent, TimelineOppositeContent, timelineOppositeContentClasses } from "@mui/lab";
      ...
      <Box >
        ...
        >
          {assetTrasactionLogs?.map((transaction)=>{
            ...
            <TimelineContent>{`Asset ${transaction?.asset_id} Recived in Organisation`} </TimelineContent>
          </TimelineItem>
            }
